...
function page() {
  return (
    <div className='m-5'>
      <div className='mb-5'>
        <div>
        おそらく404をクリックしたということは私と同じ融解班の方ですか？。
        遊んでくれてありがとうございます!!
        Project COLD2.0を遊んだ方なら分かると思いますが、物語中に出てくる100謎ガチャを再現したサイトです。
        このミッションはローラー(単語総当たり)で解かれたこともあって、もやもやしたまま終わってしまった方もいると思います。
        そこで、このサイトとLINEBOTを作りました。公開と正解のフラグを分けているためローラーで解かれない作りになっています(多分)。
